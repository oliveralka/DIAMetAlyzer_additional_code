...
# 5: fragFromDB - use the same precursor, but fragments with lower mz as prec from
...
# methods 
	...
	# TODO: Is the adduct needed here as well, when why / why not? 
	...
	# TODO: ADD CH2 to MS1 level (Precursor) 
