...
ggsave(paste(out_dir,"Coefficientofvariation5FDR.png",sep=""),plot_cv, width = p_width, height = p_height ,dpi=p_dpi)
...
for (element in unique(new_metabolites$Name))
{
  ...
  ggsave(paste(out_dir,"ExampleNormRatiolog2","_",element,"_5FDR.png",sep=""),plot_metabo_norm, width = p_width, height = p_height ,dpi=p_dpi)
  ...
  ggsave(paste(out_dir,"Examplelog2","_",element,"_5FDR.png",sep=""),plot_metabo, width = p_width, height = p_height ,dpi=p_dpi)
...
# add plot to grid 
library(gridExtra)
ggsave(paste(out_dir,"Example_combined_int.png",sep=""), arrangeGrob(plot_metabo_Amidosulfuron, plot_metabo_Azaconazole, plot_metabo_Fenpyroximate, nrow=2, ncol=2), width = p_width*2, height = p_height*2 ,dpi=p_dpi)
```
...
ggsave(paste(out_dir,"NormalizedIntensityRatio5FDR.png",sep=""),plot, width = p_width, height = p_height ,dpi=p_dpi)
...
ggsave(paste(out_dir,"NormalizedIntensityRatiolog2_5FDR.png",sep=""),plot_pyp_log2, width = p_width, height = p_height ,dpi=p_dpi)
...
# add plot to grid 
library(gridExtra)
ggsave(paste(out_dir,"combinedCV_Quant.png",sep=""), arrangeGrob(plot_pyp_log2,plot_cv, nrow=1, ncol=2), width = p_width*2, height = p_height ,dpi=p_dpi)
```
...
ggsave(paste(out_dir,"log2sdlog2_5FDR_ymax.png",sep=""), plot_dev_pyp, width = p_width, height = p_height ,dpi=p_dpi)
...
#ggsave(paste(out_dir,"log2sdlog2_5FDR_ymax.png",sep=""),plot_devsd_pyp, width = p_width, height = p_height ,dpi=p_dpi)
...
ggsave(paste(out_dir,"NormalizedIntensityRatio5FDR_skyline.png",sep=""),plot, width = p_width, height = p_height ,dpi=p_dpi)
...
ggsave(paste(out_dir,"NormalizedIntensityRatio5FDRlog2_skyline.png",sep=""),plot, width = p_width, height = p_height ,dpi=p_dpi)
...
ggsave(paste(out_dir,"log2sdlog2_5FDR_ymax_manual.png",sep=""),plot_dev_sky, width = p_width, height = p_height ,dpi=p_dpi)
...
ggsave(paste(out_dir,"log2sdlog2_5FDR_ymax_manual.png",sep=""),plot_dev_sd_sky, width = p_width, height = p_height ,dpi=p_dpi)
...
ggsave(paste(out_dir,"log2_sd_am_merged.png",sep=""),plot_m_all, width = p_width, height = p_height ,dpi=p_dpi)
.
```
...
# add plot to grid 
library(gridExtra)
ggsave(paste(out_dir,"combinedCV_sd_r.png",sep=""), arrangeGrob(plot_m_all, plot_cv , nrow=2, ncol=1), width = p_width, height = p_height ,dpi=p_dpi)
```
...
ggsave(paste(out_dir,"log2_sd_am.png",sep=""), plot_m, width = p_width, height = p_height ,dpi=p_dpi)
...
# add plot to grid 
library(gridExtra)
ggsave(paste(out_dir,"combinedDeviation.png",sep=""), arrangeGrob(plot_dev_pyp, plot_dev_sky, nrow=1, ncol=2), width = p_width*2, height = p_height ,dpi=p_dpi)
```
...
ggsave(paste(out_dir,"Coefficientofvariation5FDR_ms1.png",sep=""), plot_cv, width = p_width, height = p_height ,dpi=p_dpi)
...
ggsave(paste(out_dir,"NormalizedIntensityRatio5FDR_ms1.png",sep=""), plot, width = p_width, height = p_height ,dpi=p_dpi)
}
```
...
ggsave(paste(out_dir,"NormalizedIntensityRatio5FDR_skyline_ms1.png",sep=""), plot, width = p_width, height = p_height ,dpi=p_dpi)
}
```
