...
#SBATCH --job-name=67_02
#SBATCH --cpus-per-task 16
#SBATCH --time=48:00:00
#SBATCH --mem=128G

#SBATCH --output=/nfs/wsi/abi/scratch/alka/osw/s45_mt1_resolve_totoc_67_02/20201205_s45_mt1_resolve_totoc_67_02.stdout
#SBATCH --error=/nfs/wsi/abi/scratch/alka/osw/s45_mt1_resolve_totoc_67_02/20201205_s45_mt1_resolve_totoc_67_02.stderr

echo "Start OSW analysis"

in_path="/nfs/wsi/abi/projects/metabolomics/OpenSWATH/20200909_data_MetaboDIA/analysis/osw/pos_dia"
tmp_cached_mzml_path="/nfs/wsi/abi/scratch/tmp_cached_mzML/s45_mt1_resolve_totoc_67_02"
library_path="/nfs/wsi/abi/scratch/alka/osw/s45_mt1_resolve_totoc_67_02/20201129_s45_mt1_resolve_totoc_67_02.pqp"
out_osw_path="/nfs/wsi/abi/scratch/alka/osw/s45_mt1_resolve_totoc_67_02/osw"
out_chrom_path="/nfs/wsi/abi/scratch/alka/osw/s45_mt1_resolve_totoc_67_02/mzml"
