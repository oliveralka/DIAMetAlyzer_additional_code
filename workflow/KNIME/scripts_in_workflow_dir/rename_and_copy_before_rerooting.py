...
@click.command()
@click.option('--input', '-in', type = click.Path(), help = 'Input SIRIUS workspace directory')
@click.option('--output', '-out', type = click.Path(), help = 'Directory with extracted and renamed trees')
