...
#SBATCH --job-name=Ms02
#SBATCH --cpus-per-task 16
#SBATCH --time=48:00:00
#SBATCH --mem=128G

#SBATCH --output=/nfs/wsi/abi/scratch/alka/osw/mdia_10ppm_25ppm_min_spec_02_pf00/20201205_mdia_10ppm_25ppm_min_spec_02_pf00.stdout
#SBATCH --error=/nfs/wsi/abi/scratch/alka/osw/mdia_10ppm_25ppm_min_spec_02_pf00/20201205_mdia_10ppm_25ppm_min_spec_02_pf00.stderr

echo "Start OSW analysis"

in_path="/nfs/wsi/abi/projects/metabolomics/OpenSWATH/20200909_data_MetaboDIA/analysis/osw/pos_dia"
tmp_cached_mzml_path="/nfs/wsi/abi/scratch/tmp_cached_mzML/mdia_10ppm_25ppm_min_spec_02_pf00"
library_path="/nfs/wsi/abi/scratch/alka/osw/mdia_10ppm_25ppm_min_spec_02_pf00/20201205_DDA_tdlib_msconvert_mzXML_10ppm_min_s02_pf00.pqp"
out_osw_path="/nfs/wsi/abi/scratch/alka/osw/mdia_10ppm_25ppm_min_spec_02_pf00/osw"
out_chrom_path="/nfs/wsi/abi/scratch/alka/osw/mdia_10ppm_25ppm_min_spec_02_pf00/mzml"
